...
namespace Connect4Logic
{
    public class Game
    {
        // $G$ DSN-999 (-5) Methods should not be static
        ...
        public static void SetPcMove(GameBoard i_Matrix, PlayerInfo i_CurrentPlayer)
        {
        ...
        public static bool CheckIfWin(GameBoard i_Matrix, PlayerInfo i_CurrentPlayer)
        {
            ...
            // $G$ DSN-999 (-3) Should have had each check in different method when this general method activates each
            // Horizontal check
